...
const SandeepFooter = () => {
    ...
    const handleNavigation = () => {
        ...
        gsap.to(sectionRef.current, {
            ...
            ease: 'power2.out',
            onComplete: () => {
                router.push('/project-healing-home');
            }
        });
    };
    ...
    return (
        <div
            ...
            style={{ backgroundImage: `url('https://ik.imagekit.io/ckncpdy03/Ethical%20den%20-%20gsap/project-details/banner(3).jpg?updatedAt=1750065574300')` }}
        >
            ...
            <div className="relative z-10 px-5 md:px-10 lg:px-16 xl:px-20 2xl:max-w-screen-2xl 2xl:mx-auto text-left">
                ...
                <h1 className="text-white text-4xl md:text-6xl font-bold">Healing Home Healthcare</h1>
