...
const WeAreAllEars = ({ onSubmit, nameRef, companyRef, emailRef, phoneRef }) => {
        ...
        <div className="mt-20 md:mt-25 xl:mt-20 bg-white rounded-lg">
            ...
            <div className="mb-6 lg:flex gap-20 ">
                <div className="flex-1/3">
                    <h2 className="text-4xl lg:text-5xl xl:text-6xl font-extrabold font-helvetica leading-[1]" style={ { letterSpacing: "-0.05em" }}>We're all ears.</h2>
                    <p className="mt-5 mb-5 lg:mb-0 text-xl text-gray-700 font-helvetica ">
                    Share the juice and we’ll get back to you ASAP.
                    </p>
                </div>
                ...
                <div className="space-y-8 flex-2/3 relative">
                    ...
                    <div className="relative font-helvetica">
                        ...
                        <textarea
                            ref={projectAboutRef}
                            id="projectAbout"
                            className="mt-1 block w-full p-6 pt-8 pb-24 bg-[#111] text-white text-xl font-bold font-helvetica"
                            onFocus={handleFocus}
                            onBlur={handleBlur}
                        />
                    </div>
