...
const AboutUsArea = () => {
  ...
  return (
    <div className='bg-change-anim pt-40  flex items-center'>
      <div className='container mx-auto px-4'>
        ...
        <div className='grid grid-cols-2 gap-10'>
          {/* 1st text */}
          <div>
            <p className='text-4xl text-[#9EFCF1] my-10 font-ethosnova'>
          ...
          <div className='mt-14'>
            <Image
              ...
              height={1000}
              width={1000}
              className='object-cover h-full w-[60vh]'
              alt='Project 1'
            />
          </div>
          ...
          <div className=''>
            <Image
              ...
              height={1000}
              width={1000}
              className='object-cover w-[30vh] h-[30vh]'
              alt='Project 1'
            />
          </div>

          {/* 2nd video */}
          <div className='flex justify-end mt-3 mr-48'>
            <video
              src='/video/about-us/TheAgency1_2.mov'
              muted
              autoPlay
