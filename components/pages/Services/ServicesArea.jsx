...
const ServicesArea = () => {
    ...
    useEffect(() => {
        ...
        const videos = [video1Ref.current, video2Ref.current, video3Ref.current, video4Ref.current, video5Ref.current, video6Ref.current, video7Ref.current, video8Ref.current, video9Ref.current, video10Ref.current];
                    ...
                    <div className='grid grid-cols-1 sm:grid-cols-2  gap-80 md:gap-40 lg:gap-45 xl:gap-50  justify-center items-center w-full'>
                        ...
                        <div className="-mt-[300px] md:-mt-0" ref={el => videoContainerRefs.current[0] = el}>
                            <div className="relative h-[35vh] md:h-[40vh] lg:h-[60vh] w-full" ref={video1Ref}>
                                ...
                                {/* Fixed service list */}
                                <div
                                    className='absolute  -bottom-55 md:-bottom-97 lg:-bottom-68 xl:-bottom-60 left-0 text-white pointer-events-none'
                        ...
                        <div className="-mt-1 md:-mt-[700px]" ref={el => videoContainerRefs.current[1] = el}>
                            <div className="relative h-[35vh] md:h-[40vh] lg:h-[60vh] w-full" ref={video2Ref}>
                               <img
                                ...
                                {/* Fixed service list */}
                                <div
                                    className='absolute -bottom-80 md:-bottom-132 lg:-bottom-94 xl:-bottom-86 left-0 text-white pointer-events-none'
                        ...
                        <div className="mt-30 md:mt-[320px] lg:mt-[200px] xl:mt-[400px]" ref={el => videoContainerRefs.current[2] = el}>
                            <div className="relative h-[35vh] md:h-[40vh] lg:h-[60vh] w-full" ref={video3Ref}>
                                ...
                                {/* Fixed service list */}
                                <div
                                    className='absolute -bottom-56 md:-bottom-90 lg:-bottom-65 xl:-bottom-62 left-0 text-white pointer-events-none'
                        ...
                        <div className="mt-20 md:-mt-[300px] lg:-mt-[500px] xl:-mt-[750px]" ref={el => videoContainerRefs.current[3] = el}>
                            <div className="relative h-[35vh] md:h-[40vh] lg:h-[60vh] w-full" ref={video4Ref}>
                                ...
                                {/* Fixed service list */}
                                <div
                                    className='absolute -bottom-64 md:-bottom-110 lg:-bottom-71 xl:-bottom-75 left-0 text-white pointer-events-none'
                        ...
                        <div className="mt-30 md:mt-80 lg:mt-50 xl:mt-100" ref={el => videoContainerRefs.current[4] = el}>
                            <div className="relative h-[35vh] md:h-[40vh] lg:h-[60vh] w-full" ref={video5Ref}>
                                ...
                                {/* Fixed service list */}
                                <div
                                    className='absolute  -bottom-64 md:-bottom-97 lg:-bottom-80 xl:-bottom-73 left-0 text-white pointer-events-none'
                        ...
                        <div className="mt-24 md:-mt-[100px] lg:-mt-[450px] xl:-mt-[700px]" ref={el => videoContainerRefs.current[5] = el}>
                            <div className="relative h-[35vh] md:h-[40vh] lg:h-[60vh] w-full" ref={video6Ref}>
                                ...
                                {/* Fixed service list */}
                                <div
                                    className='absolute -bottom-106 md:-bottom-185 lg:-bottom-128 xl:-bottom-100 2xl:-bottom-88 left-0 text-white pointer-events-none'
                                ...
                                >
                                    <ul className='text-xl md:text-2xl leading-relaxed font-helvetica space-y-1 md:space-y-3'>
                                        ...
                                        <li>E-commerce Website Development with Shopify or Woocomerce</li>
                        ...
                        <div className="mt-64 md:mt-[320px] lg:mt-[300px] xl:mt-[400px]" ref={el => videoContainerRefs.current[6] = el}>
                            <div className="relative h-[35vh] md:h-[40vh] lg:h-[60vh] w-full" ref={video7Ref}>
                                ...
                                {/* Fixed service list */}
                                <div
                                    className='absolute -bottom-70 md:-bottom-116 lg:-bottom-85 xl:-bottom-64 left-0 text-white pointer-events-none'
                        ...
                        <div className="mt-34 md:mt-120 lg:-mt-[90px] xl:-mt-[580px]" ref={el => videoContainerRefs.current[7] = el}>
                            <div className="relative h-[35vh] md:h-[40vh] lg:h-[60vh] w-full" ref={video8Ref}>
                                ...
                                {/* Fixed service list */}
                                <div
                                    className='absolute -bottom-108 md:-bottom-155 lg:-bottom-105 xl:-bottom-95 2xl:-bottom-80 left-0 text-white pointer-events-none'
                                    ref={el => serviceListRefs.current[7] = el}
                                >
                                    <ul className='text-xl md:text-2xl leading-relaxed font-helvetica md:space-y-3'>
                        ...
                        <div className="mt-70 lg:mt-80" ref={el => videoContainerRefs.current[8] = el}>
                            <div className="relative h-[35vh] md:h-[40vh] lg:h-[60vh] w-full" ref={video9Ref}>
                                ...
                                {/* Fixed service list */}
                                <div
                                    className='absolute  -bottom-70 md:-bottom-95 lg:-bottom-84 xl:-bottom-60 left-0 text-white pointer-events-none'
                        ...
                        <div className="mt-30 md:mt-140 lg:mt-40 xl:-mt-[300px]" ref={el => videoContainerRefs.current[9] = el}>
                            <div className="relative h-[35vh] md:h-[40vh] lg:h-[60vh] w-full" ref={video10Ref}>
                                ...
                                >
                                    ...
                                    <p style={{ letterSpacing: "-0.05em" }} className="text-4xl md:text-4xl lg:text-5xl xl:text-6xl font-helvetica font-extrabold mt-4">
                                        Photo & Video <br />Editing
                                    </p>
                                </div>

                                {/* Fixed service list */}
                                <div
                                    className='absolute -bottom-53 md:-bottom-90 lg:-bottom-70 xl:-bottom-74 left-0 text-white pointer-events-none'
