...
const GalleryMain = () => {
    ...
    return (
        <>
            <section ref={sectionRef} className="min-h-screen  mt-5 md:mt-[1vh] lg:mt-[1vh] 2xl:mt-[60px] py-10 px-5   relative">
                <div className='flex justify-center items-center'>
                    <div className="grid grid-cols-2 lg:grid-cols-4 xl:grid-cols-5 gap-6 w-full relative">
                        ...
                        <div ref={col1Ref} className="space-y-6">
                            <div className="bg-[#09e5e5] text-black lg:mt-22 2xl:mt-10 h-[35vh] md:h-[50vh] lg:h-[38vh] xl:h-[45vh] p-4 md:p-6 rounded-2xl w-full">
                            ...
                            <img src="/images/gallery/gallery-1.jpg" alt="Award" className="rounded-2xl h-[35vh] md:h-[50vh] lg:h-[38vh] xl:h-[45vh] w-full" />
                        </div>

                        {/* Second Column (animated up) */}
                        <div ref={col2Ref} className="space-y-6 flex flex-col mt-30 lg:mt-30 xl:mt-40 ">
                            <div className="bg-black text-white h-[35vh] p-4 md:p-6 rounded-2xl  w-full md:h-[50vh] lg:h-[38vh] xl:h-[45vh]">
                            ...
                            <div className="bg-[#a8ff57] text-black h-[35vh] md:h-[50vh] p-4 md:p-6 rounded-2xl w-full lg:h-[38vh] xl:h-[45vh]">
                        ...
                        <div ref={col4Ref} className="space-y-6 -mt-28 md:-mt-28 lg:mt-30 2xl:mt-20">
                            <div className="bg-black text-white h-[35vh] md:h-[50vh] lg:h-[38vh] xl:h-[45vh] p-4 md:p-6 rounded-2xl w-full">
                            ...
                            <div className="bg-[#a8ff57] text-black h-[35vh] md:h-[50vh] lg:h-[38vh] xl:h-[45vh] p-4 md:p-6 rounded-2xl w-full">
                        ...
                        <div ref={col5Ref} className="space-y-6 flex flex-col  lg:mt-20 xl:mt-40">
                            ...
                            <div className="bg-[#09e5e5] text-black h-[35vh] md:h-[50vh] lg:h-[38vh] xl:h-[45vh] p-4 md:p-6 rounded-2xl w-full ">
