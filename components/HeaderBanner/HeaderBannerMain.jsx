...
const HeaderBannerMain = () => {
    ...
    return (
        <div className="relative h-screen overflow-hidden bg-[#f5f6f2]">
            {/* Navbar */}
            <nav className="fixed top-0 left-0 w-full z-10 flex items-center justify-between px-10 py-6 bg-[#f5f6f2]">
            ...
            {/* Banner Content */}
            <div ref={bannerRef} className="absolute inset-0 flex flex-col items-center justify-center pointer-events-none z-30">
                ...
                {/* Videos and Image */}
                <div className="absolute left-0 top-1/2 -translate-y-1/2 w-[380px] h-[380px] rounded-xl overflow-hidden shadow-lg">
                    <video src="/images/banner/banner-v-left.mp4" autoPlay loop muted className="w-full h-full object-cover" />
                </div>

                <div className="absolute top-0 left-1/2 -translate-x-1/2 w-[380px] h-[340px] rounded-xl overflow-hidden shadow-lg z-20">
                    <video src="/images/banner/banner-v-top.mp4" autoPlay loop muted className="w-full h-full object-cover" />
                </div>

                <div className="absolute right-0 top-1/2 -translate-y-1/2 w-[380px] h-[380px] rounded-xl overflow-hidden shadow-lg">
                    <img src="/images/banner/banner-v-right.jpg" alt="Right Visual" className="w-full h-full object-cover" />
                </div>

                <div className="absolute bottom-0 left-1/2 -translate-x-1/2 w-[380px] h-[300px] rounded-xl overflow-hidden shadow-lg">
