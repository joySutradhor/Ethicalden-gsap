...
export const metadata = {
  ...
  description: "MrCafe is a cozy and smart café website designed by Ethical Den to modernize food & beverage business presence.",
  keywords: ["MrCafe", "Café Website", "Food Business", "Ethical Den Café Project"],
  metadataBase: new URL("https://ethicalden-gsap.netlify.app"),
  openGraph: {
    title: "MrCafe Project - Ethical Den",
    description: "Explore the digital identity of MrCafe — crafted by Ethical Den for delightful café experiences.",
