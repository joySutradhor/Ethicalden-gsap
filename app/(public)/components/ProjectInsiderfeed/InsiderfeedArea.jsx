        ...
        <div className='mt-20 mb-10 px-5 md:px-10 xl:px-20 2xl:max-w-screen-2xl 2xl:mx-auto'>
            <div className='flex flex-col lg:flex-row justify-between gap-10'>
                ...
                <div className='lg:w-3/4 flex gap-5'>
                    ...
                    <div className='hidden lg:flex lg:flex-col gap-5 items-start lg:items-end'>
                        <button className='border border-gray-300 p-4 rounded-full hover:bg-gray-100 transition'>
...
export default InsiderfeedArea;
